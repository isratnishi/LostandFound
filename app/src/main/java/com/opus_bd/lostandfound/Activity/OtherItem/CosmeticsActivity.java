...
public class CosmeticsActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
 ...
 /*   PrimaryInformation*/
    ...
    @BindView(R.id.spnCosmeticsType)
    Spinner spnCosmeticsType;

    @BindView(R.id.rowCosmeticsName)
    TableRow rowCosmeticsName;

    @BindView(R.id.spnbrand)
    Spinner spnCosmeticsBrandType;

    @BindView(R.id.rowCosmeticsBrandName)
    TableRow rowCosmeticsBrandName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //date picker
        initializeVariables();
        spnCosmeticsType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
            {
                String selectedItem = parent.getItemAtPosition(position).toString();

                if(selectedItem.equals(getResources().getString(R.string.spn_others)))
                {
                     rowCosmeticsName.setVisibility(View.VISIBLE);
                }
        ...
        }); spnCosmeticsBrandType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                if(selectedItem.equals(getResources().getString(R.string.spn_others)))
                {
                    rowCosmeticsBrandName.setVisibility(View.VISIBLE);
                }
            } // to close the onItemSelected
            public void onNothingSelected(AdapterView<?> parent)
            {
    ...
    public void getAllColor() {
        ...
        colors.enqueue(new Callback<List<Colors>>() {
            ...
            public void onFailure(Call<List<Colors>> call, Throwable t) {
                Toast.makeText(CosmeticsActivity.this, "Fail to connect " + t.toString(), Toast.LENGTH_SHORT).show();
            }
        });
...
//Date Picker
    ...
    void showDate(int year, int monthOfYear, int dayOfMonth, int spinnerTheme) {
        new SpinnerDatePickerDialogBuilder()
                .context(this)
                .callback(CosmeticsActivity.this)
